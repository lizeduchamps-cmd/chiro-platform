...
const SKIP_KEYWORDS = [
  ...
  "tel:", "tel ", "www.", "http", "btw-nr", "ondernemingsnr", "order-datum", "order:",
  "telefonist", "bestelling type", "customer phone", "geprint op", "eet smakelijk",
  "ma- do", "ma-vr", "ma - vr", "ma-do",
];

// OCR verwart cijfers vaak met vergelijkbaar gevormde letters (O/0, I of l/1,
// S/5, B/8, Z/2, C/0) — vooral op vaal thermisch bonpapier of in een dicht
// factuur-lettertype. De prijs-match staat dat toe en normaliseert enkel
// binnen de gevonden prijs zelf, nooit in de omschrijving ernaast.
const OCR_CIJFER = "[0-9OoIlLSsBbZzCc]";
